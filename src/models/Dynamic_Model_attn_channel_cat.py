...
try:
    ...
    from . import self_attention_for_hw_no_gamma
except:
    import self_attention_for_hw
    import self_attention_for_hw_no_gamma
...
class MDGAN_S1_G(nn.Module):
    def __init__(self, ngf=32, sn=False, args=None):
        ...
        if args.attention_type == "HW":
            print("Use HW.")
            SA = self_attention_for_hw.SelfAttentionForHW
        elif args.attention_type == "noGammaHW":
            print("Use noGammaHW!!!!!!!!!!!!!!!!!")
            SA = self_attention_for_hw_no_gamma.SelfAttentionForHW
