...
class BaseNetGenerator(nn.Module):
    ...
    def __init__(self, in_dim=3, out_dim=3, filters=32, norm='instance'):
        ...
        self.attn_Dhw_4 = SelfAttentionForHW(self.filters*2, self.L_relu)
