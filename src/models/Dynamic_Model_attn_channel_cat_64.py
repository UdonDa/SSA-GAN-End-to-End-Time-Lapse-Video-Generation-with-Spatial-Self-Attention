...
class MDGAN_S1_G(nn.Module):
    ...
    def __init__(self, ngf=64, sn=False):
...
if __name__ == "__main__":
    ...
    G1_true = MDGAN_S1_G(sn=True)
    G1_false = MDGAN_S1_G(sn=False)
